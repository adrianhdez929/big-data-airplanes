...
HDFS_DIR = '/user/data/airplanes_data/'
...
def save_data(data, timestamp):
    ...
    filename = f"airplanes_data_{timestamp}.json"
...
def generate_table(messages, files):
    ...
    table = Table(title="Airplanes Data Monitor")
    table.add_column("Timestamp", justify="center", style="cyan")
    table.add_column("States", justify="right", style="green")
...
if __name__ == "__main__":
    console.print("[yellow]Starting Airplanes Data Monitor...[/yellow]")
    try:
        main()
